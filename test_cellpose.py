...
# define the filename
#image_path = r"A01.czi"
image_path = r"CH=3.czi"
...
chindex_nucleus = 0  # channel containing the objects, e.g. the nuclei
...
cp_model = load_cellpose_model(model_type='nuclei', gpu=True, net_avg=True)
    ...
    with pyczi.open_czi(image_path) as czidoc_r:
        ...
        for s, t, z, in product(range(sizeS),
            ...
            if mdata.image.SizeS is None:
                ...
                img2d = czidoc_r.read(plane={'T': t, 'Z': z, 'C': chindex_nucleus}, scene=s)[..., 0]
